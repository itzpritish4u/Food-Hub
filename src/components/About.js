      ...
      <div className="flex flex-col-reverse md:flex-row  mx-16 justify-between">
        <div className="flex flex-col w-full  md:w-3/5">
          ...
          <div className="flex justify-center md:justify-start gap-5 my-4 ">
            <a
              href="https://www.linkedin.com/in/pritish-kumar-ram/"
              target="_blank"
            ...
            <a
              href="https://github.com/itzpritish4u"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://auth.geeksforgeeks.org/user/rajpritish75"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://leetcode.com/geekprit4u/"
              target="_blank"
              rel="noopener noreferrer"
            >
